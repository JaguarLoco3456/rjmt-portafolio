  ...
  return (
    <div className="App">
      ...
      {mostrarExperiencia && (
       ...
       <p>
         También he trabajado con instituciones como <strong>Bancomext</strong> en la optimización de su estrategia digital, así como en el desarrollo de sistemas de monitoreo para la <strong>prevención de riesgos reputacionales, identificando crisis potenciales</strong> a partir de tendencias emergentes en redes sociales.
       </p>
       <p>
